...
#  Created on Tue Sep 21 16:44:10 2021                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site FreePDK45_38x28_10R_NP_162NW_34O -r 1.0 0.8 5 5 5 5
uiSetTool select
getIoFlowFlag
fit
setIoFlowFlag 0
floorPlan -site FreePDK45_38x28_10R_NP_162NW_34O -r 0.979020979021 0.799227 5.13 5.04 5.13 5.04
uiSetTool select
getIoFlowFlag
fit
...
reset_parasitics
extractRC
rcOut -setload dlx.setload -rc_corner high
rcOut -setres dlx.setres -rc_corner high
rcOut -spf dlx.spf -rc_corner high
rcOut -spef dlx.spef -rc_corner high
reset_parasitics
extractRC
